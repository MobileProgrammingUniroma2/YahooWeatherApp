    ...
    public void refreshWeather(String l){
        ...
        new AsyncTask<String, Void, String>(){
            ...
            protected String doInBackground(String... params) {
                ...
                //String YQL = String.format("select * from weather.forecast where woeid in (select woeid from geo.places where text=\"%s\")", params[0]);
            ...
            protected void onPostExecute(String s){
                ...
                if(s == null && error != null){
                    Log.d("ON_POST_FAILED", "String s is null");
                ...
                try {
                    ...
                    Log.d("JSON_CATCH_FAILURE", "JSON has encountered problems");
